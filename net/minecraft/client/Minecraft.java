...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        EventHandler.registerClass(Client.INSTANCE);
        EventHandler.call(new EventStartClient(Client.INSTANCE.getClientName() + " b" + Client.INSTANCE.getClientBuild()));
    ...
    public void runTick() throws IOException {
        //EventHandler.call(new EventTick(EventTick.Type.EVERYWHERE));
        ...
        if (this.currentScreen == null && this.thePlayer != null) {
            EventHandler.call(new EventTick(EventTick.Type.WORLD));
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.getEventKeyState()) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        EventHandler.call(new EventKeyPress(k));
                        if (k == 1) {
