...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void sendChatMessage(String message) {
        EventChatMessage eventChatMessage = new EventChatMessage(message);
        EventHandler.call(eventChatMessage);
        if (eventChatMessage.isCancelled()) return;
        this.sendQueue.addToSendQueue(new C01PacketChatMessage(eventChatMessage.getMessage()));
    }
